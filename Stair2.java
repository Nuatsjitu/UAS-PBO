...
import java.util.*;
/**
 * Write a description of class Stair2 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class Stair2 extends Shape
{
    /**
     * Act - do whatever the Stair2 wants to do. This method is called whenever
    ...
    public void rotate () {
        if (getRotation() == 0 ) {
            ...
            List checkIntersection1 = getObjectsAtOffset (60,40,Blocks.class);
            ...
            List checkIntersection3 = getObjectsAtOffset (-60,0,Blocks.class);
            ...
            checkIntersection2.remove (this);
            List checkIntersection3 = getObjectsAtOffset (0,-40,Blocks.class);
            checkIntersection3.remove (this);
            if (checkIntersection.isEmpty () && checkIntersection1.isEmpty ()){
                setRotation (0);
                setLocation (getX () -20,getY () -20);
    ...
    public int [] createIt () {
        if (getRotation () == 0) {
            int x = ((getX () - 445)/40);
            int y = ((getY () - 45)/40);
            Game.gameboard [x+1] [y-1] = 5;
            Game.gameboard [x] [y] = 5;
            Game.gameboard [x] [y+1] = 5;
            Game.gameboard [x+1] [y] = 5;
